...
import LineFadeText from '../TextAnimations/LineFadeText';
import './About.css';
...
const BIO_PARAGRAPHS = [
  ...
  'Research & Analytics: I contributed to autonomous navigation projects at DRDO and drove predictive analytics during my time at Guavus.',
  ...
  'Personal Interests: When I am not at my desk, I stay active at the gym and on the football field. I am a long-time gamer on PC and Nintendo Switch, usually found under the tag trippy_boi1. I also enjoy staying current with system design and generative AI through audiobooks and technical newsletters.',
];
    ...
    <section id="about" className="about">
      ...
      >
        <div className="about-content">
          ...
          <LineFadeText paragraphs={BIO_PARAGRAPHS} className="about-bio" />
        </div>
